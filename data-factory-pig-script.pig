...
RENTAL_DATA_UNQ = FOREACH RENTAL_DATA_FILTER  GENERATE rental_id, inventory_id, customer_id, (datetime) ToDate(SUBSTRING(REPLACE(rental_date, 'NO_DATA',''),1,10),'YYYY-MM-DD') AS rental_date; 
